...
const words = [
  ...
  {text: 'React Select', value: Math.random()*100}, {text: 'Message', value: Math.random()*100}, {text: 'Aws', value: Math.random()*100},
  {text: 'Aws Ec2', value: Math.random()*100}, {text: 'Aws Rds Database', value: Math.random()*100}
]
const options = {
